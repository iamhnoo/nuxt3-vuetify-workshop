...
useHead({
	...
	meta: [
		{
			name: "keywords",
			content: "บล็อก,โปรแกรมบัญชี, CD Organizer, Backend",
		},
		{
			name: "Description",
			content: "บล็อก โปรแกรมบัญชี,  Com Developer co.th",
		},
	],
});
			...
			<v-row justify="center">
				<v-col cols="12" sm="10" md="9" lg="7">
					<div class="text-center">
						...
						<p class="text-white">You can relay on our amazing features list and also our customer services will be great experience for you without doubt and in no-time</p>
					</div>
				</v-col>
			</v-row>
		</div>
				...
				<v-col cols="12" md="6" lg="4" v-for="(product, index) in products" :key="index">
					<v-card elevation="0" class="blog-card overflow-hidden mb-5" :to="`/blogdetail/${product.id}`">
						<div class="position-relative mb-5">
							<!--<a href="#">-->
							<v-img :src="product.imageurl" alt="blog" class="blog-img" />
							<!--</a>-->
						...
						<div class="pa-5">
							<v-card-title href="#" class="blog-title text-decoration-none font-weight-medium font-18">{{ product.topic }}</v-card-title>
							<v-card-subtitle class="mt-10 mb-10">{{ product.detail }}</v-card-subtitle>
							<a href="#" class="text-themecolor linking text-decoration-none d-flex align-center"> อ่านต่อ &nbsp; <i class="mdi mdi-arrow-right"></i> </a>
						</div>
					</v-card>
				</v-col>
			</v-row>
