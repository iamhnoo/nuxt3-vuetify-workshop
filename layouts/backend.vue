	...
	<div>
		<v-app>
			...
			<v-app-bar elevation="0" color="primary">
				<div class="pe-5">
					<NuxtLink to="/backend/dashboard" class="d-flex brand"> NuxtPress </NuxtLink>
				</div>
			...
			<v-main>
				...
				<!---Sidebar -->
				<!-- ---------------------------------------------- -->
				<v-navigation-drawer left :permanent="mdAndUp" elevation="10" app :temporary="mdAndDown" v-model="drawer" expand-on-hover>
					<Sidebar />
				</v-navigation-drawer>
