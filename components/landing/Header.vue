...
<template>
	<div>
		<v-app-bar app color="blue accent-4" dark elevation="0">
			...
			<ClientOnly>
				<pre><NuxtLink to="/" class="d-block d-lg-none brand ml-8"><b>CD Organizer</b></NuxtLink></pre>
			</ClientOnly>
			<v-container>
				<v-row>
					<v-col class="d-none d-lg-block" sm="12" md="12" lg="4">
						<v-toolbar-title>
							<ClientOnly>
								<pre><NuxtLink to="/" class="d-flex brand mt-2"><b>CD Organizer</b></NuxtLink></pre>
							</ClientOnly>
						</v-toolbar-title>
					</v-col>
		...
		<!-- Mobile Menu -->
		<v-navigation-drawer left elevation="10" app :temporary="mdAndUp" v-model="drawer" expand-on-hover>
			<v-list>
